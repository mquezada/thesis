...
In particular, Chapter~\ref{chapter:data} describes how we use the Standard
Search API to retrieve the tweets used in the following chapters.



\section{Supervised learning: Classification}
\todo[inline]{ser explicito con las fuentes}

The basic premise of learning from data lies in the use of a set of observations
to uncover an underlying process~\cite{Abu-Mostafa:2012:LD:2207825}. 
%
...
%
The value of $\lambda$ can be derived empirically or by use of a value being
